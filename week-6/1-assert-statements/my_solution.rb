...
def assert
raise "Assertion failed" unless alabama = VirusPredictor.new("Alabama", STATE_DATA["Alabama"][:population_density], STATE_DATA["Alabama"][:population], STATE_DATA["Alabama"][:region], STATE_DATA["Alabama"][:regional_spread]) 
alabama.virus_effects == "Alabama will lose 482202 people in this outbreak and will spread across the state in 2 months."

raise "Assertion failed" unless jersey = VirusPredictor.new("New Jersey", STATE_DATA["New Jersey"][:population_density], STATE_DATA["New Jersey"][:population], STATE_DATA["New Jersey"][:region], STATE_DATA["New Jersey"][:regional_spread]) 
jersey.virus_effects == "New Jersey will lose 3545836 people in this outbreak and will spread across the state in 0.5 months."

raise "Assertion failed" unless california = VirusPredictor.new("California", STATE_DATA["California"][:population_density], STATE_DATA["California"][:population], STATE_DATA["California"][:region], STATE_DATA["California"][:regional_spread]) 
california.virus_effects == "California will lose 15216572 people in this outbreak and will spread across the state in 0.5 months."

raise "Assertion failed" unless alaska = VirusPredictor.new("Alaska", STATE_DATA["Alaska"][:population_density], STATE_DATA["Alaska"][:population], STATE_DATA["Alaska"][:region], STATE_DATA["Alaska"][:regional_spread]) 
alaska.virus_effects == "Alaska will lose 36572 people in this outbreak and will spread across the state in 2.5 months."
end
